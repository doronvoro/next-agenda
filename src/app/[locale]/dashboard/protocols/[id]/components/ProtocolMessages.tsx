...
const ProtocolMessages: React.FC<ProtocolMessagesProps> = ({
  ...
  const t = useTranslations("dashboard.protocols.messages");
      ...
      if (selectedRecipients.length > 0) {
        try {
          ...
          if (!emailResponse.ok) {
            ...
            setError(`${t("messageSentSuccessfully")} ${t("messageSentButEmailFailed")} ${emailResult.error}`);
          } else {
            console.log("Email sending result:", emailResult);
            // Show success message for email
            if (emailResult.note) {
              setError(`${t("messageSentSuccessfully")} ${emailResult.note}`);
            }
          }
        } catch (emailError) {
          console.error("Error sending emails:", emailError);
          setError(t("messageSentButEmailNetworkError"));
        }
      }
  ...
  const handleTemplateChange = (template: string) => {
    ...
    switch (template) {
      ...
      case "pre-meeting materials":
        setNewMessage(t("templates.preMeetingMaterialsText"));
        break;
      case "protocol approval":
        setNewMessage(t("templates.protocolApprovalText"));
        break;
  ...
  // Debug logs
  console.log("🔍 ProtocolMessages Debug:");
  console.log("Translation namespace:", "dashboard.protocols.messages");
  console.log("Translation function:", t);
  console.log("Title translation:", t("title"));
  console.log("No messages found translation:", t("noMessagesFound"));
  console.log("Type your message translation:", t("typeYourMessage"));
  console.log("Select recipients translation:", t("selectRecipients"));
  console.log("Selected translation:", t("selected"));
  console.log("Choose template translation:", t("chooseTemplate"));
  console.log("Clear translation:", t("clear"));
  console.log("Send message translation:", t("sendMessage"));
          ...
          <form onSubmit={handleSendMessage} className="flex flex-col space-y-2">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                >
                  {t("selectRecipients")} ({selectedRecipients.length} {t("selected")})
                </button>
                <div className="flex items-center space-x-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="select-template">{t("selectTemplate")}</SelectItem>
                      <SelectItem value="pre-meeting materials">{t("preMeetingMaterials")}</SelectItem>
                      <SelectItem value="protocol approval">{t("protocolApproval")}</SelectItem>
                      <SelectItem value="general message">{t("generalMessage")}</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
