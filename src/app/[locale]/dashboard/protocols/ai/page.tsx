  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">AI Protocol Assistant</h1>
          <p className="text-muted-foreground">Chat with AI to create your protocol</p>
        </div>
      </div>
      
      <div className="flex flex-row h-[70vh] max-w-6xl mx-auto">
        <div className="flex-1 flex flex-col bg-background border rounded-xl shadow-lg overflow-hidden mr-6">
          <div className="flex-shrink-0 px-6 py-4 border-b bg-muted">
            ...
            <p className="text-muted-foreground text-sm">Start by providing the protocol number</p>
          </div>
          <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4 bg-background">
            {messages.length === 0 && (
              <div className="text-center text-muted-foreground py-8">
                <p>Welcome! I'm here to help you create a protocol.</p>
                <p className="text-sm mt-2">Start by telling me the protocol number.</p>
              </div>
            )}
            {messages.map((msg) => (
              <div
