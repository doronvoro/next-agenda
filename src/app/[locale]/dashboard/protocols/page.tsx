...
import { RtlProvider, useRtl } from "@/context/RtlContext";
import CommitteeDropdown from "./components/CommitteeDropdown";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <AppDropdown
                ...
                options={[
                  ...
                  { value: "due-soon", label: t("dueSoon") },
                  { value: "on-track", label: t("onTrack") },
                ]}
